...
do
	...
	function ra_surface.DrawQuad( x1, y1, x2, y2, x3, y3, x4, y4 )
		q1.x, q1.y = x1, y1
		q2.x, q2.y = x2, y2
		q3.x, q3.y = x3, y3
		q4.x, q4.y = x4, y4
	...
	function ra_surface.DrawQuadUV( x1, y1, x2, y2, x3, y3, x4, y4 )
	...
	local drawline = surface.DrawLine
 	function ra_surface.DrawOutlinedQuad(x1, y1, x2, y2, x3, y3, x4, y4)
...
do
	...
	local drawquad = ra_surface.DrawQuad
	function ra_surface.DrawArc( _x, _y, r1, r2, aStart, aFinish, steps )
...
do
	...
	local ang2rad = 3.141592653589/180
	local drawline = surface.DrawLine
	function ra_surface.DrawArcOutline( _x, _y, r1, r2, aStart, aFinish, steps )
		aStart, aFinish = aStart*ang2rad, aFinish*ang2rad
		local step = (( aFinish - aStart ) / steps)
		local c = steps
